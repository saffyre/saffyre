...
class Underscore
{
     ...
     *
     * @param \Traversable|array $list the list to iterate over
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to map
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to reduce
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to iterate over
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to filter
     ...
     *
     * @param \Traversable|array $list the list of items to filter
     * @param \Traversable|array $properties the key-values pairs each filtered item must match
     *
     * @return array
     */
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to invoke method/function onto
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to sort
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to index
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to group
     * @param callable,scalar $iterator the function to generate the key or a property name
     * @param object $context optional, if provided will become the context of $iterator
     *
     * @return array
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to group and count
     * @param callable,scalar $iterator the function to generate the key or a property name
     * @param object $context optional, if provided will become the context of $iterator
     *
     * @return array
     ...
     * @category Collection Functions
     *
     * @param \Traversable|array $list the list of items to shuffle
     *
     * @return array
     */
     ...
     * @category Collection Functions
     *
     * @param mixed|\Traversable $list the list of items
     *
     * @return array
     */
     ...
     *
     * @param \Traversable|array $array the list of items
     * @param int $n optional, the number of items to pick
     ...
     * @category Array Functions
     *
     * @param \Traversable|array $array multiple, the arrays to join
     *
     * @return array
     */
     ...
     * @category Array Functions
     *
     * @param \Traversable|array $array multiple, the arrays to intersect
     *
     * @return array
     */
     ...
     * @category Array Functions
     *
     * @param \Traversable|array $array multiple, the arrays to difference
     *
     * @return array
     */
     ...
     * @category Array Functions
     *
     * @param \Traversable|array $array multiple, the arrays to zip
     *
     * @return array
     */
    ...
    /**
     * Divides an array into the specified number of chunks. The array will be divided as evenly as possible with the
     * lower-indexed chunks containing extra items as necessary.
     *
     * @category Array Functions
     *
     * @param \Traversable|array $array the list of items
     * @param int $count the number of chunks to divide the list into
     *
     * @return array
     */
    public static function divide($array, $count)
    {
        $array = static::toArray($array);
        $n = floor(count($array) / $count);
        $excess = count($array) - ($n * $count);
        $result = [];
        $offset = 0;
        while ($count--) {
            // Take a chunk of $n items from the $array.
            // If $excess is > 0, take 1 additional item and subtract 1 from $excess.
            $result[] = array_slice($array, $offset, $chunkSize = $n + ($excess ? (int)!!$excess-- : 0), true);
    ...
    public static function bind(\Closure $function, $object)
    {
        ...
        @$reset_error_stack; // intentional E_NOTICE with undefined variable
     ...
     *
     * @param \Traversable|array $object the list from which the keys are extracted
     *
     * @return array
     */
     ...
     * @category Object Functions
     *
     * @param \Traversable|array|object $object the list from which the values are extracted
     *
     * @return array
     */
     ...
     * @category Object Functions
     *
     * @param \Traversable|array $object the list of items to convert to pairs
     *
     * @return array
     */
     ...
     * @category Object Functions
     *
     * @param \Traversable|array $object the object to invert
     *
     * @return object,array
     */
     ...
     * @category Object Functions
     *
     * @param \Traversable|array $object the object to pick properties on
     ...
     * @category Object Functions
     *
     * @param \Traversable|array $object the object to exclude keys from
     ...
     * @category Object Functions
     *
     * @param \Traversable|array $object the object to fill
     * @param \Traversable|array $defaults multiple, the objects or array that will fill object's missing keys
     *
     ...
     * @category Object Functions
     *
     * @param \Traversable|array $object the object to clone
     *
     * @return object,array
     */
     ...
     * @category Object Functions
     *
     * @param \Traversable|array $properties the properties used by predicate
     *
     * @return \Closure
     */
     ...
     * @category Internal Functions
     *
     * @param array|\Traversable $properties the properties to filter on
     *
     * @return \Closure
     */
